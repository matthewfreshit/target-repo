...
function Get-MetroBusRouteDirectionInfo {
    <#
    .SYNOPSIS
        Gets direction information for the specified bus stop.
    .DESCRIPTION
        Get-MetroBusRouteDirectionInfo will return direction information for the specified bus stop.
...
Export-ModuleMember -Function Get-MetroBusRouteDirectionInfo